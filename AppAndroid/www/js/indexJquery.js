      var jQuery = $.noConflict();
			...
			{  
				...
				var d = new Date();
				jQuery("#txtFechaPublicacionNP").val(d.getDate() + "/" + (d.getMonth()+1) + "/" + d.getFullYear());
						...
						{				
							...
							for(j=0; j < listPropiedades.length; j++)
							{
								...
								if(j==0) {
									...
									itemsPropiedad += "<li class='u-inline-block'><span class='icon-icoMedidas'></span>"+listPropiedades[j][4]+mtarea+".</li>";
									itemsPropiedad += "</ul>";
									itemsPropiedad += "</div>";
									itemsPropiedad += "</a>";
									itemsPropiedad += "</li>";	
								...
								itemsPropiedadLista += "<li class='u-inline-block'><span class='icon-icoMedidas'></span>"+listPropiedades[j][4]+mtarea+".</li>";
								...
								if(listPropiedades[j][30]==1){
									...
									itemsMiPropiedad += "<li class='u-inline-block'><span class='icon-icoMedidas'></span>"+listPropiedades[j][4]+mtarea+".</li>";
									itemsMiPropiedad += "</ul>";
								...
								marcadores[j][8] = listPropiedades[j][4]+" "+mtarea;
								...
								if(listPropiedades[j][27]==1){
									...
									itemsPropiedadFavorita +="<li class='u-inline-block'><span class='icon-icoMedidas'></span>"+listPropiedades[j][4]+mtarea+".</li>";
				...
				{
					if(validar_campo("#txtCerroTerminacionVenta",1,"Nombre de quien cerro la operación"))
								...
								{			
									...
									jQuery.ajax(
									{
										...
										data	: 
										{
											...
											txtCerroTerminacionVenta				: jQuery("#txtCerroTerminacionVenta").val()
										},
										success	: function(HTMLRespuesta)
										{			
											var respuesta = parseInt(HTMLRespuesta);	
			...
			*/
			...
			function cargarPropiedadesDestacadas() 
			{
				...
				for(a=0; a < listPropiedadesDescatacas.length; a++)
				{
					...
					if(a==0) {
						...
						itemsPropiedadDescatada += "<li class='u-inline-block'><span class='icon-icoMedidas'></span>"+listPropiedades[j][4]+mtarea+".</li>";
						itemsPropiedadDescatada += "</ul>";
			...
			function datosAsoacido(id_a){
				...
				function datosPropiedad(pos){
					...
					if(listPropiedades[pos][21]=="Renta")
						jQuery(".DetallePropiedades-ListDatosGenerales li").eq(1).html("<span class='icoPropiedad--PrecioRenta'></span>PrecioRenta MN <span>"+listPropiedades[pos][3]+"</span>");
					else
						jQuery(".DetallePropiedades-ListDatosGenerales li").eq(1).html("<span class='icoPropiedad--PrecioRenta'></span>PrecioVenta MN <span>"+listPropiedades[pos][3]+"</span>");

					jQuery(".DetallePropiedades-ListDatosGenerales li").eq(2).html("<span class='icoPropiedad--Superficie Total'></span>"+listPropiedades[pos][4]+mtarea+" Superficie total");
					...
					if(listPropiedades[pos][30]==1){
						...
						jQuery(".dtTipoOperacionC").html(""+listPropiedades[pos][21]);

						if(listPropiedades[pos][6]==1)
							jQuery(".ConcluirVentaFp").slideUp('slow');
						else
							jQuery(".ConcluirVentaFp").slideDown('slow');
					}
					...
					if(datosUsuario[2]==4){
						jQuery(".PostNoticia-Compartir").attr('onclick',"window.plugins.socialsharing.share('"+listPropiedades[pos][1]+"', null, '"+urlBasePropiedad+listSliderPropiedad[0][1]+"', 'http://villahermosa.ampiserver.net/modulos/Propiedades/verPropiedadPDF/"+listPropiedades[pos][0]+"/"+listPropiedades[pos][15]+"');");
					...
					{
						jQuery(".PostNoticia-Compartir").attr('onclick',"window.plugins.socialsharing.share('"+listPropiedades[pos][1]+"', null, '"+urlBasePropiedad+listSliderPropiedad[0][1]+"', 'http://villahermosa.ampiserver.net/modulos/Propiedades/verPropiedadPDF/"+listPropiedades[pos][0]+"/"+datosUsuario[3]+"');");
			...
			function verDatosPropiedad(pos){
				...
				jQuery("#stUnidadMedidaEP option[value="+ listPropiedades[pos][36] +"]").attr("selected",true);
				...
				if(listPropiedades[pos][17]==4)
					jQuery("#stUnidadMedidaEP").slideDown("slow");
				else
					jQuery("#stUnidadMedidaEP").slideUp("slow");
			...
			function agregarFavorito(pos){
				...
				itemsPropiedadFavorita +="<li class='u-inline-block'><span class='icon-icoMedidas'></span>"+listPropiedades[pos][4]+mtarea+".</li>";
				itemsPropiedadFavorita +="</ul>";
				itemsPropiedadFavorita +="</div>";
				itemsPropiedadFavorita +="</a>";
				itemsPropiedadFavorita +="</li>";
					...
					success	: function(Respuesta)
					{
						...
						for(var j=0; j < listDatos.length; j++)
						{
							if(j==0) {
								...
								jQuery("#stTipoPropiedadNP").change(function(){
									if(jQuery(this).val()==4)
										jQuery("#stUnidadMedidaNP").slideDown("slow");
									else
										jQuery("#stUnidadMedidaNP").slideUp("slow");
								});

								jQuery("#stTipoPropiedadEP").change(function(){
									if(jQuery(this).val()==4)
										jQuery("#stUnidadMedidaEP").slideDown("slow");
									else
										jQuery("#stUnidadMedidaEP").slideUp("slow");
